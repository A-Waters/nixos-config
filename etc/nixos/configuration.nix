...

{
  ...
  # bugged https://github.com/hyprwm/Hyprland/issues/6967

  # stop sleep since its broken right now  https://discourse.nixos.org/t/weird-behaviour-after-suspend-gnome/38210
